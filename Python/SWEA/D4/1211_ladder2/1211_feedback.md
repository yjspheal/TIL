...
- [총평](#총평)
- [보완점](#보완점)
  - [1. 수직 이동 보조 while 제거로 로직 단순화](#1-수직-이동-보조-while-제거로-로직-단순화)
  - [2. 하드코딩(100) 제거 및 시작점 스캔 범위 명확화](#2-하드코딩100-제거-및-시작점-스캔-범위-명확화)
  - [3. 구조화 \& 가독성(타입 힌트, main 분리)](#3-구조화--가독성타입-힌트-main-분리)
- [최종 코드 예시](#최종-코드-예시)
